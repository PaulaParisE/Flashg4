...
public class PhotoPreference {
    ...
    private static final String GROUP_PHOTO = "com.example.paulapariselias.flash.data.KEY.GROUP_PHOTO";
    private static final String KEY_PHOTO = "com.example.paulapariselias.flash.data.KEY.KEY_PHOTO";
